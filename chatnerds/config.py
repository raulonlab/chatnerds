...
class Config(object):
    ...
    _YOUTUBE_SOURCES_FILENAME: ClassVar[str] = "youtube.sources"  # Name of the youtube sources file
    _PODCAST_SOURCES_FILENAME: ClassVar[str] = "podcast.sources"  # Name of the podcast sources file
    ...
    def get_nerd_config(self, nerd_name: Optional[str] = None):
        ...
        active_nerd_config = self.read_nerd_config(config.get_nerd_base_path(nerd_name = nerd_name))
        
        merged_nerd_config = self.merge_config(default_config, active_nerd_config)
        merged_nerd_config["chroma"]["persist_directory"] = str(Path(config.get_nerd_base_path(nerd_name = nerd_name), self._DB_NAME))
    ...
    def get_nerd_youtube_sources(self, nerd_name: Optional[str] = None) -> List[str]:
        ...
        nerd_youtube_sources_path = Path(config.NERDS_DIRECTORY_PATH, nerd_name, self._YOUTUBE_SOURCES_FILENAME)
    ...
    def get_nerd_podcast_sources(self, nerd_name: Optional[str] = None) -> List[str]:
        ...
        nerd_podcast_sources_path = Path(config.NERDS_DIRECTORY_PATH, nerd_name, self._PODCAST_SOURCES_FILENAME)
